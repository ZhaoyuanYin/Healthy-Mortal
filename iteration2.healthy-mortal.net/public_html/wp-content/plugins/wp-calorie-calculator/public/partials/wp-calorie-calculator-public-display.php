...
<div class="wpcc-title" style="<?php echo $title_show ? '' : 'display: none'; ?>"><?php echo esc_attr( $title_text ); ?></div>
	...
	<form>
		...
		<div class="wpcc-group">
			...
			<div class="wpcc-row wpcc-row-basic wpcc-metric<?php echo ! $metric_system ? ' imperial' : ''; ?>">
				...
				<div class="wpcc-input-wrapper wpcc-age">
					...
					<div class="wpcc-input">
						<input type="number" class="wpcc-need-validate" id="wpcc-age" name="wpcc-age" placeholder="<?php esc_attr_e( 'years', 'wp-calorie-calculator' ); ?>">
					</div>
				</div>
				...
				<div class="wpcc-input-wrapper wpcc-weight">
					...
					<div class="wpcc-input">
						<input type="number" class="wpcc-need-validate" id="wpcc-weight" name="wpcc-weight" step="0.1" required>
						<label for="wpcc-weight" class="wpcc-input-unit"><?php echo $metric_system ? esc_attr__( 'kg', 'wp-calorie-calculator' ) : esc_attr__( 'lbs', 'wp-calorie-calculator' ); ?></label>
					</div>
				</div>
				...
				<div class="wpcc-input-wrapper wpcc-height">
					...
					<div class="wpcc-row">					
						<div class="wpcc-input">
							<input type="number" class="wpcc-need-validate" id="wpcc-height" name="wpcc-height" step="0.1" required>
							<label for="wpcc-height" class="wpcc-input-unit"><?php echo $metric_system ? esc_attr__( 'cm', 'wp-calorie-calculator' ) : esc_attr__( 'ft', 'wp-calorie-calculator' ); ?></label>
						</div>
						...
						<div class="wpcc-input" style="<?php echo $metric_system ? 'display:none;' : ''; ?>">
							...
							<label for="wpcc-height-2" class="wpcc-input-unit"><?php esc_attr_e( 'in', 'wp-calorie-calculator' ); ?></label>
						</div>
					</div>
				</div>			
