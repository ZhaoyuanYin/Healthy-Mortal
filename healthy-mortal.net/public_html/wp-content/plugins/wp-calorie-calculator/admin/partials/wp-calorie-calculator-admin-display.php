		...
		<div class="wpcc-settings-wrapper">
				...
				<div class="wpcc-settings-header">
					...
					<div class="wpcc-settings-tabs">
								...
								<div class="wpcc-settings-group-title">
									...
									<div class="wpcc-switch">
										<div class="wpcc-switch-option" data-position="left">
											<?php esc_attr_e( 'Email', 'wp-calorie-calculator' ); ?></div>
										<label class="wpcc-switch-toggle">
											<input type="checkbox" name="wpcc-instant-result" value="true"
										...
										<div class="wpcc-switch-option" data-position="right">
											<?php esc_attr_e( 'Instant view', 'wp-calorie-calculator' ); ?></div>
									</div>
								</div>

								<div class="wpcc-settings-group-content wpcc-notification-email-wrapper" style="<?php echo $instant_result ? 'display:none;' : ''; ?>">
									...
									<div class="wpcc-settings-group block-disabled">
										...
										<div class="wpcc-settings-group-content">
											<p class="wpcc-settings-description wpcc-settings-description--100">
												<?php esc_attr_e( 'In Zapier, create a zap and select "Webhooks by Zapier" as the launch application and "Catch Hook" as the launch event type. Zapier will give you the Custom Webhook URL - paste it into this field and save your settings. All data will now be sent to your Zapier account.', 'wp-calorie-calculator' ); ?>
												<br>
								...
								<div class="wpcc-settings-group-content">
									<div class="wpcc-settings-color-schema" >								
										<table class="wpcc-settings-color-table">
											<tbody>
												<tr>
													<td><label for="wpcc_schema_color_custom"><?php esc_attr_e( 'Choose a general color scheme', 'wp-calorie-calculator' ); ?></label></td>
						...
						<section id="templates-settings" class="wpcc-settings-section block-disabled">
							...
							<div class="wpcc-settings-group">
								<div class="wpcc-settings-group-text-block">
									<p class="wpcc-settings-description">
										<?php esc_attr_e( 'Enter the text that is sent to users and admin after completion of calculation', 'wp-calorie-calculator' ); ?>
									</p>
								...
								<div class="wpcc-settings-group">
									...
									<div class="wpcc-settings-group-content">
										...
										<p class="wpcc-settings-description wpcc-settings-description--100"><?php esc_html_e( 'Fill in the From Name and From fields - for example, WP Calorie Calculator and calculator. Leave these fields blank if you want to use the default WordPress settings or configured on the site SMTP.', 'wp-calorie-calculator' ); ?></p>
										<div class="wpcc-settings-row">
											<label class="wpcc-settings-group-label mr"><?php esc_html_e( 'From Name', 'wp-calorie-calculator' ); ?>
												<input class="disabled" type="text" name="wpcc_email_user_from_name" disabled/>
											</label>
											<label class="wpcc-settings-group-label text-left"><?php esc_html_e( 'From', 'wp-calorie-calculator' ); ?>
			...
			<div class="wpcc-settings-sidebar">
				<div class="wpcc-banner">
					<div class="wpcc-banner-title"><?php esc_attr_e( 'The Pro edition of WP Calorie Calculator is out!', 'wp-calorie-calculator' ); ?></div>
					<div class="wpcc-banner-description"><?php esc_attr_e( 'Mailchimp integration, flexible settings, custom templates and other exciting additions - try now and make your website users’ favorite place to be!', 'wp-calorie-calculator' ); ?></div>
