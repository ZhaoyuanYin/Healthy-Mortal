...
class WP_Calorie_Calculator_Admin {
	...
	public function pro_version_advertisement() {
		...
		if ( ! get_option( 'wpcc_pro_version_advertisement' ) ) :
			...
			<div class="notice notice-success updated is-dismissible">
				...
				<p><?php echo __( 'Mailchimp integration, flexible settings, custom templates and other exciting additions - try now and make your website users’ favorite place to be!', 'wp-calorie-calculator' ); ?></p>
	...
	public function wpcc_pro_plugin_settings_link( $wpcc_settings_links ) {
		if ( ! get_transient( 'wpcc_pro_deactivate' ) ) {
			$pro_settings_link = '<a href="https://wpcaloriecalculator.com/?visitsource=wporgfree" style="font-weight: 600;color: red;" target="_blank">' . __( 'Get PRO', 'christmas-music' ) . '</a>';
