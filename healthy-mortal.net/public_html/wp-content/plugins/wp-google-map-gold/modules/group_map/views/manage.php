...
if ( class_exists( 'FlipperCode_List_Table_Helper' ) and ! class_exists( 'Wpgmp_Manage_Group_Table' ) ) {
	...
	global $wpdb;
	$columns   = array(
		'group_map_title'   => esc_html__( 'Marker Category Name', 'wpgmp-google-map' ),
	...
	$tableinfo = array(
		...
		'translation' => array(
			'manage_heading'      => esc_html__( 'Manage Marker Categories', 'wpgmp-google-map' ),
			'add_button'          => esc_html__( 'Add Category', 'wpgmp-google-map' ),
			'delete_msg'          => esc_html__( 'Marker category was deleted successfully.', 'wpgmp-google-map' ),
			'insert_msg'          => esc_html__( 'Marker category was added successfully.', 'wpgmp-google-map' ),
			'update_msg'          => esc_html__( 'Marker category was updated successfully.', 'wpgmp-google-map' ),
