...
$form->add_element(
	...
	array(
		'value' => esc_html__('The very first step to get started with Google Maps is to create the right API key for your website. While creating the Google Maps API keys from the Google Cloud Platform, in the key restriction section, you need to choose HTTP referrer and then you will need to enter HTTP referrer according to your website domain name.', 'wpgmp-google-map') . '<br><br>' . esc_html__('You need to enter this HTTP referrer during the key creation process :   ', 'wpgmp-google-map') . ' &nbsp;&nbsp;&nbsp;&nbsp;<b><span class="wpgmp_referrer">'.$referrer. '</span></b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="hidden" id="wpgmp_referrer" value="'.$referrer.'"> <span class="tooltip"><span class="copy_to_clipboard"><img src="'. WPGMP_IMAGES. '/copy-to-clipboard.png">  <span class="tooltiptext" id="myTooltip">'.esc_html__('Copy HTTP Referrer To Clipboard','wpgmp-google-map').'</span></span></span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.wpmapspro.com/docs/how-to-create-an-api-key/" target="_blank">View Tutorial</a>',
