...
Commenter avatars come from <a href="https://gravatar.com">Gravatar</a>.'
		...
		if ( empty( $first_page ) ) {
			...
			$first_page .= sprintf(
				...
				__( 'As a aaa new WordPress user, you should go to <a href="%s">your dashboard</a> to delete this page and create new pages for your content. Have fun! try to code' ),
				admin_url()
			);
			$first_page .= "</p>\n<!-- /wp:paragraph -->";
		}
